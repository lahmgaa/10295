...
<body>
    ...
    <div id="graph_back">
        <img src="img/graph_back2.png" alt="back" width="800px" height="auto">
    </div>
    ...
    <div id="graph1">
        <img src="img/graph1.png" alt="graph" width="620px">
    </div>
    <div id="graph2">
        <img src="img/graph2.png" alt="graph" width="620px">
    </div>
    <div id="graph21">
        <img src="img/graph21.png" alt="graph" width="620px">
    </div>
    <div id="graph22">
        <img src="img/graph22.png" alt="graph" width="620px">
    </div>
    <div id="graph23">
        <img src="img/graph23.png" alt="graph" width="620px">
    </div>
    <div id="graph24">
        <img src="img/graph24.png" alt="graph" width="620px">
    </div>
    <div id="graph211">
        <img src="img/graph211.png" alt="graph" width="620px">
    </div>
    <div id="graph212">
        <img src="img/graph212.png" alt="graph" width="620px">
    </div>
    <div id="graph221">
        <img src="img/graph221.png" alt="graph" width="620px">
    </div>
    <div id="graph222">
        <img src="img/graph222.png" alt="graph" width="620px">
    </div>
    <div id="graph231">
        <img src="img/graph231.png" alt="graph" width="620px">
    </div>
    ...
    <div id="graph32">
        <img src="img/graph32.png" alt="graph" width="620px">
    </div>
    <div id="graph311">
        <img src="img/graph311.png" alt="graph" width="620px">
    </div>
    <div id="graph321">
        <img src="img/graph321.png" alt="graph" width="620px">
    </div>
    <div id="graph322">
        <img src="img/graph322.png" alt="graph" width="620px">
    </div>
    <div id="graph4">
        <img src="img/graph4.png" alt="graph" width="620px">
    </div>
    <div id="graph4_2">
        <img src="img/graph4.png" alt="graph" width="620px">
    </div>
    ...
    <div id="graph5">
        <img src="img/graph5.png" alt="graph" width="620px">
    </div>
...
<video controls id="vi322" >
    ...
    <div id="selectend">
        ...
        <div id="boxgraph231">추천하는 음식 방송!</div>
